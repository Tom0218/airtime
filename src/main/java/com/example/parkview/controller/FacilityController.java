...
public class FacilityController {
	...
	//前端搜尋設施模糊搜尋
	@GetMapping(value = "api/park/getAllFacilityRegx")
	public List<Facility> searchRegx(@RequestParam(value = "name", required = false) String name){
		return facilityDao.searchRegx(name); 
	}
	...
	//新增設施留言
	@GetMapping(value = "api/park/createComment")
	public BasicRes create(
			@RequestParam(value = "comments", required = false) String comments,
			@RequestParam(value = "nickname", required = false) String nickname,
			@RequestParam(value = "facilityName", required = false) String facilityName) {
			Comment comment = new Comment();
			comment.setFactilityName(facilityName);
			comment.setPlayer(nickname);
	...
	//搜尋留言
	@GetMapping(value = "api/park/searchComment")
	public List<Comment> searchComment(
			@RequestParam(value = "facilityName", required = false) String facilityName){
		return commentDao.searchComments(facilityName);
	}
